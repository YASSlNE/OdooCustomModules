...
# #### notification corrigé par houssem ############"
####update 19-02-2019 by YAAKOUBI GHAIDA#######
#
...
#     lieuCreate = fields.Selection([('Tunis', "Tunis"), ('Sfax', "Sfax"), ('Sejnene', "Sejnene"), ], default='Tunis')
...
#     transport = fields.Selection([('Vehicule Personel', "Personal vehicle"), ('Autre', "Other"), ], 'Transport',
...
#
#     state = fields.Selection([('draft', "In creation"), ('annuler', "Cancel"),
#                               ('modifier', "Waiting for change"),
#                               ('envoyer', "Waiting validation1"),
#                               ('confirmerA', "Waiting validation2"), ('confirmerV', "Waiting to print"),
...
#         if self.heureDebut:
#             date_x = datetime.strptime(self.heureDebut, "%Y-%m-%d %H:%M:%S")
#             print("date_x*********************", date_x)
